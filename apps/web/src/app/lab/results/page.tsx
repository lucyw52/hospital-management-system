  ...
  return (
    <DashboardLayout navItems={navItems} userName="Lab Tech" userRole="Laboratory Technician">
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-blue-600">Result Entry</h1>
          <p className="text-gray-600 mt-1">Enter test results</p>
        </div>

        <Card>
          <div className="text-center py-12 text-gray-500">
            <div className="text-6xl mb-4">📝</div>
            <p>Use the main dashboard to enter results for pending tests</p>
          </div>
        </Card>
      </div>
    </DashboardLayout>
